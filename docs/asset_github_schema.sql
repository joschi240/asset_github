...
CREATE TABLE `core_asset_kategorie` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `core_runtime_agg_day` (
...
CREATE TABLE `core_runtime_counter` (
  `asset_id` int(11) NOT NULL,
...
CREATE TABLE `core_runtime_sample` (
  `id` bigint(20) NOT NULL,
  `asset_id` int(11) NOT NULL,
...
CREATE TABLE `stoerungstool_aktion` (
  `id` bigint(20) NOT NULL,
...
CREATE TABLE `stoerungstool_ticket` (
  `id` bigint(20) NOT NULL,
...
CREATE TABLE `wartungstool_protokoll` (
  `id` bigint(20) NOT NULL,
...
CREATE TABLE `wartungstool_wartungspunkt` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) NOT NULL,
...
-- Indizes / Constraints / AUTO_INCREMENT
