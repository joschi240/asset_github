...
--  - Collation/Charset wie im Dump: utf8mb4_general_ci.
-- =====================================================================
...
-- =====================================================================
-- STOERUNGSTOOL: Tickets + Aktionen
-- =====================================================================

-- stoerungstool_ticket
-- Zweck: Mängel/Störungen inkl. Status-Workflow:
--  neu → angenommen → in_arbeit → erledigt → geschlossen
CREATE TABLE IF NOT EXISTS stoerungstool_ticket (
  ...
  status ENUM('neu','angenommen','in_arbeit','erledigt','geschlossen') NOT NULL DEFAULT 'neu',
...
CREATE TABLE IF NOT EXISTS stoerungstool_aktion (
  ...
  user_id INT(11) DEFAULT NULL,
  text TEXT NOT NULL,
  status_neu ENUM('neu','angenommen','in_arbeit','erledigt','geschlossen') DEFAULT NULL,
